...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 495.0, 95.0, 20.0 ],
					"text" : "s #0_fromClient"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 600.0, 93.0, 20.0 ],
					"text" : "r #0_fromClient"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 540.0, 120.0, 29.0 ],
					"text" : "OSC In"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 60.0, 405.0, 61.0, 20.0 ],
					"text" : "route text"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 150.0, 375.0, 135.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 120.0, 15.0, 150.0, 20.0 ],
					"text" : "From Client OSC Port"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 360.0, 330.0, 225.0 ],
					"rounded" : 18
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 285.0, 79.0, 20.0 ],
					"text" : "r #0_toClient"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 90.0, 81.0, 20.0 ],
					"text" : "s #0_toClient"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.0, 90.0, 120.0, 29.0 ],
					"text" : "OSC Out"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 180.0, 135.0, 105.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 120.0, 75.0, 150.0, 20.0 ],
					"text" : "Synapse Client IP"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 165.0, 195.0, 61.0, 20.0 ],
					"text" : "route text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 225.0, 81.0, 20.0 ],
					"text" : "prepend host"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 60.0, 195.0, 61.0, 20.0 ],
					"text" : "route text"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 135.0, 120.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 120.0, 45.0, 150.0, 20.0 ],
					"text" : "To Client OSC Port"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 165.0, 315.0, 137.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 120.0, 330.0, 225.0 ],
					"rounded" : 18
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 630.0, 144.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 60.0, 106.0, 20.0 ],
